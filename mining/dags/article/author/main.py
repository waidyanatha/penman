...
def run():
    inputs = {
        ...
        "aptitude":'A Chinese native unversity undergraduate junior, a public safety administration major, studying at University of Toronto',
...
def main():
    ...
    try:
        ...
        from mining.modules.article.author import crew as cr
